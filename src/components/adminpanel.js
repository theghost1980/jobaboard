        ...
        <div className="adminPanelCont">
            <div className="adminPanelMenu">
                ...
                <ul className="standardUlVerSmall">
                    ...
                    <li onClick={() => setComponentSelected("support")}
                        className={`standardLink ${componentSelected === "support" ? `activeInnerMenu`: null}`}
                    >
                        Tickets - Support
                    </li>
                    <li onClick={() => setComponentSelected("faqs")}
                        className={`standardLink ${componentSelected === "faqs" ? `activeInnerMenu`: null}`}
                    >
                        FAQs
                    </li>
                    {/* <li>
            ...
            <div className="adminRenderContainer marginBottom">
                    ...
                    {
                        (componentSelected === "support") && <Managesupport />
                    }
                    {
                        (componentSelected === "faqs") && <Managefaqs />
                    }
            </div>
            {
                users.length > 0 ?
