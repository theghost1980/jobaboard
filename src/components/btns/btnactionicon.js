 ...
 * @param {String} typeIcon - Type of icon, for now just "refresh"
...
const Btnactionicon = (props) => {
    ...
    return (
        <div title={title ? title : null } className={`${xclassCSS} justBorders justRounded`} onClick={clicked}>
            <Img fixed={data.refresh_orange.childImageSharp.fixed} />
        </div>
    )
}
