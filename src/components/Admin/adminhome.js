...
const Adminhome = () => {
    return (
        <div className="standardContentMargin">
            ...
            <p>Note: for now is fetching all posts on @sexosentido as test account. Later on, @jobaboard depending on options or admin tags.</p>
            <Visualizator noFilter={false} hiveUser={"sexosentido"} limit={20} openMode={"onTopOfAll"} filter_tags={arTags}/>
        </div>
    )
}
