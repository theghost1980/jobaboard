...
const Nftlogic = (props) => {
    ...
    return (
        ...
        <div className={`standardFlexCol95 ${working ? 'disableDiv': null}`}>
            {
                working && 
            ...
            }
            {
                ...
                }
                {
                    ...
                    <ul className="standardUlHorSmall">
                        ...
                        {/* <li>
                            Work more for me and <button>Create More</button>
                        </li>
                        <li>Find current instances of {newNFT.symbol} {" "}
                            <button onClick={getInstances}>Check</button>
                        </li> */}
                    </ul>
                    </div>
                }
