...
const Generaltesting = () => {
    // const BeeChatMessage = useContext(BeeChat);
    // console.log(BeeChatMessage);
    ...
    useEffect(() => {
        if(chatStatus === "online"){
            const actualToken = localStorage.getItem("bToken"); //get the data.
            // var count = 0;
    ...
    return (
        ...
        {/* <div>
            ...
            {
                chatMessage && <p>{JSON.stringify(chatMessage)}</p>
            }
            {
                chatStatus && 
        ...
        <Tabs>
                ...
                <TabPanel>
                    <div className={chatStatus === "online" ? null : 'disableDiv3'}>
                        <div className="standardDivRowFullW">
                            <div className="standardDivColFullW">
                                <ul className="standardUlColW90pFullH noMarginBTP justRounded brightText">
                                    ...
                                    {
                                        (selector === "chats") && <Listitems unread={unread} items={conversations} toList={selector} username={"theghost1980"} selectedItemCb={handleItem}/>
                                    }
                                    ...
                                    </li>
                                    {
                                        (selector === "channels") && 
                                        <div>
                                            <Listitems items={channels} toList={selector}/>
                                            <li>TODO...</li>
                                        </div>
                                    }
                                </ul>
