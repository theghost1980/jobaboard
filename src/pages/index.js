  ...
  return (
      <Layout>
        <div className="homepageContainer">
          ...
          <div className="marginsTB textAlignedCenter">
            <h2>Annoucements on JAB@blog</h2>
            <Visualizator hiveUser={"sexosentido"} limit={10}  filter_tags={['general-accounces']} openMode={"onTopOfAll"}
              xclassCSS={"standardDivFlexPlain bordersRounded justshadows bgBlocksBlue justWidthAuto justiAlig"} devMode={false} hideRefreshBtn={true}
